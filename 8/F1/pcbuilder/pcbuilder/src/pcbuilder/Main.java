            ...
            if (i1.equalsIgnoreCase("O")) {
                ...
                order: {
                    while (true) {
                        ...
                        System.out.println("2) Intel Core-i9 11th Gen PC");
                        ...
                        if (i2.equalsIgnoreCase("O")) {
                            ...
                            System.out.println("Please select the RAM: ");
                            ...
                            if (i3.trim().equals("1")) dtor.addMem2666(builder);
                                ...
                                System.out.println("Invalid input, cancelling item. You may add another item.");
                                continue;
                            }

                            System.out.println("Please select the Graphics card: ");
                            System.out.println("1) 2GB");
                            System.out.println("2) 4GB");
                            String i4 = scanner.nextLine();
                            if (i4.trim().equals("1")) dtor.addGraphics2G(builder);
                            else if (i4.trim().equals("2")) dtor.addGraphics4G(builder);
                            else {
                                System.out.println("Invalid input, cancelling item. You may add another item.");
                                continue;
                            }
